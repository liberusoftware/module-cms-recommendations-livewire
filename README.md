...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-recommendations-livewire?sort=semver)](https://github.com/liberusoftware/module-cms-recommendations-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-recommendations-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-recommendations-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-recommendations-livewire
```
...
<a href="https://github.com/liberusoftware/module-cms-recommendations-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-recommendations-livewire" alt="Contributors to liberusoftware/module-cms-recommendations-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-recommendations-livewire/graphs/contributors).
